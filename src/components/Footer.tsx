        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="https://linkedin.com/in/rajeev-ranjan"
                target="_blank"
              ...
              <a
                href="https://facebook.com/rajeev.ranjan"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors"
              >
              ...
              <a
                href="https://api.whatsapp.com/send?phone=919876543210&text=Hi%20Rajeev,%20I%20found%20your%20website%20and%20would%20like%20to%20discuss..."
                target="_blank"
                rel="noopener noreferrer"
