  ...
  return (
    <Layout>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-muted rounded-lg focus:ring-2 focus:ring-brand-green focus:border-transparent transition-colors bg-card"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border border-muted rounded-lg focus:ring-2 focus:ring-brand-green focus:border-transparent transition-colors resize-vertical bg-card"
                ...
                <button
                  ...
                  className="w-full bg-brand-green hover:bg-brand-green/90 disabled:bg-brand-green/50 text-background px-8 py-4 rounded-lg font-semibold inline-flex items-center justify-center space-x-2 transition-all duration-300 hover-lift shadow-elegant disabled:transform-none"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+919195180016" className="text-text hover:text-brand-green transition-colors">
                      +91 91951 80016
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@enviroandipr.com" className="text-text hover:text-brand-green transition-colors">
                      info@enviroandipr.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text">New Delhi, India</p>
                  </div>
                </div>
              ...
              <div className="bg-brand-green/5 rounded-xl p-6 border border-brand-green/20">
                ...
                <button
                  ...
                  className="bg-brand-green hover:bg-brand-green/90 text-background px-6 py-3 rounded-lg font-semibold inline-flex items-center space-x-2 transition-all duration-300 hover-lift shadow-elegant"
                >
      ...
      <FAQTabs
        ...
        subtitle="Get answers to common questions about our services, process, and how we can help your business"
      />
    </Layout>
  );
};
